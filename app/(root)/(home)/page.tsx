...
const Home = () => {
  ...
  // Format the time without seconds in 12-hour format with AM/PM
  const time = now.toLocaleTimeString('en-US', {
    hour: 'numeric',
    minute: 'numeric',
    hour12: true,
    timeZone: 'Asia/Karachi', // Timezone for Islamabad, PK
  });

  // Format the current date as "Day, Month Date, Year"
